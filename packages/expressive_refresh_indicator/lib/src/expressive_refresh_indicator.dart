...
final Motion _settleMotion = SpringMotion(SpringDescription.withDampingRatio(mass: 1, stiffness: 1500), snapToEnd: true);
...
/// method.
class ExpressiveRefreshIndicatorState extends State<ExpressiveRefreshIndicator> with TickerProviderStateMixin<ExpressiveRefreshIndicator> {
  ...
  late final BoundedSingleMotionController _fraction = BoundedSingleMotionController(
  ...
  double _distanceFractionFor(double dragOffset) {
    ...
    final double tensionPercent = linearTension - (linearTension * linearTension) / 4.0;
  ...
  Widget build(BuildContext context) {
    final Widget child = NotificationListener<ScrollNotification>(
      ...
      child: NotificationListener<OverscrollIndicatorNotification>(onNotification: _handleIndicatorNotification, child: widget.child),
    );
    assert(() {
      if (_status == null) {
        assert(_dragOffset == null);
                ...
                child: Align(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? _) {
                      ...
                      final double translate = fraction * _kIndicatorMaxDistance - _kIndicatorSize;
                      return Transform.translate(
                        offset: Offset(0.0, _isIndicatorAtTop! ? translate : -translate),
  ...
  Widget _buildIndicator(BuildContext context, double fraction) {
    final String label = widget.semanticsLabel ?? MaterialLocalizations.of(context).refreshIndicatorSemanticLabel;
