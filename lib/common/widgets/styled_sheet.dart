...
class StyledSheet extends StatelessWidget {
  ...
  static Future<bool> show(
    ...
    final bool? confirmed = await showExpressiveSheet<bool>(
      context: context,
      builder: (context) {
        return StyledSheet(icon: icon, title: title, message: message, confirmLabel: confirmLabel, destructive: destructive);
      },
    );
  ...
  Widget build(BuildContext context) {
    ...
    final Color heroBackground = destructive ? cs.errorContainer : cs.secondaryContainer;
    final Color heroForeground = destructive ? cs.onErrorContainer : cs.onSecondaryContainer;
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Container(
                    ...
                    decoration: ShapeDecoration(
                      ...
                      shape: MaterialShapeBorder(shape: destructive ? MaterialShapes.sunny : MaterialShapes.cookie7Sided),
                    ),
                ...
                Text(
                  message,
                  textAlign: .center,
                  style: tt.bodyMedium?.copyWith(height: 1.4, color: cs.onSurfaceVariant),
                ),
                24.gap,
                SizedBox(
                  height: 56,
