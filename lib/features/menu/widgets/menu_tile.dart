...
class MenuTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      shape: RoundedRectangleBorder(borderRadius: borderRadius ?? BorderRadius.circular(MenuSection.innerRadius)),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(title, style: tt.bodyLarge?.copyWith(color: titleColor)),
                      if (subtitle != null) ...[2.gap, Text(subtitle!, style: tt.bodyMedium?.copyWith(color: accessoryColor))],
                    ],
                  ),
                ),
                if (trailing != null) ...[
